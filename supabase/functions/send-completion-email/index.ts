        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
          ...
          <tr>
            <td align="center" style="padding-bottom:36px;">
              ...
              <div style="font-size:11px;letter-spacing:3px;color:rgba(242,217,208,0.60);margin-bottom:6px;">CHENG FLOWERS</div>
              <div style="font-size:12px;letter-spacing:1px;color:rgba(242,217,208,0.65);">花轟 ✕ 2026 鹽夏不夜埕</div>
            </td>
          </tr>
          ...
          <tr>
            <td style="background:linear-gradient(160deg,rgba(242,126,147,0.10) 0%,rgba(242,190,92,0.05) 100%);border:1px solid rgba(242,126,147,0.20);border-radius:18px;padding:32px 28px;">
              ...
              <p style="margin:0 0 24px;font-size:12px;color:rgba(242,217,208,0.75);letter-spacing:2px;text-align:center;">十五種花語 · 任務達成</p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:rgba(242,190,92,0.07);border:1px solid rgba(242,190,92,0.18);border-radius:12px;padding:16px 20px;margin-bottom:20px;">
                    ...
                    <p style="margin:0;font-size:13px;line-height:1.95;color:rgba(242,217,208,0.92);">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:rgba(242,126,147,0.07);border:1px solid rgba(242,126,147,0.18);border-radius:12px;padding:18px 20px;">
                    ...
                    <p style="margin:0 0 12px;font-size:13px;line-height:1.85;color:rgba(242,217,208,0.92);">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:12px;">
                      <tr><td style="font-size:13px;color:rgba(242,217,208,0.90);line-height:2;padding-left:8px;">
                    ...
                    <p style="margin:0;font-size:12px;line-height:1.8;color:rgba(242,217,208,0.80);">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="border-top:1px solid rgba(242,217,208,0.08);padding-top:16px;">
                    <p style="margin:0 0 8px;font-size:11px;font-weight:600;color:rgba(242,217,208,0.70);letter-spacing:0.5px;">活動規則</p>
                    <ul style="margin:0;padding-left:16px;font-size:11px;line-height:1.9;color:rgba(242,217,208,0.65);">
                      <li>每位帳號限兌換一次，本活動好禮共 10 份，兌完為止</li>
                      <li>請於活動結束前完成預約並前來領取，<strong style="color:rgba(242,217,208,0.80);">逾期恕不補發</strong></li>
          ...
          <tr>
            <td align="center" style="padding:28px 0 48px;">
              <p style="margin:0 0 4px;font-size:11px;color:rgba(242,217,208,0.50);letter-spacing:1px;">
                領獎請以回覆本信方式聯繫
              </p>
              <p style="margin:0;font-size:11px;color:rgba(242,217,208,0.45);letter-spacing:1px;">
                花轟 × 2026 鹽夏不夜埕 · 埕花
              </p>
            </td>
          </tr>
